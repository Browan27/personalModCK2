...
NCharacter = {
	...
	CHANGE_AMBITION_YEARS = 1,						-- Delay between being able to pick a new ambition
	CHANGE_FOCUS_YEARS = 1,							-- Delay between being able to change focus
	...
	ASSIGN_ACTION_DAYS = 31, 						-- Days before a Councillor can be assigned a new job in a county
	...
	RAISED_TROOPS_VASSAL_OPINION_DAYS = 180,			-- After 61 days of having their troops raised, vassals will get -1 opinion more of you
	...
	DYNASTY_CONTROLS_RELIGIOUS_HEAD_PRESTIGE = 4,	-- Monthly Prestige from a dynasty member as head of a religion (only for counts+ and if the same religion)
	DYNASTY_CONTROLS_RELIGIOUS_HEAD_PIETY = 2,		-- Monthly Piety from a dynasty member as head of a religion (only for counts+ and if the same religion)
...
-- Title Destruction Prestige Cost
	...
	DUKE_DESTRUCTION_PRESTIGE_COST = 0,
	KING_DESTRUCTION_PRESTIGE_COST = 0,
	EMPEROR_DESTRUCTION_PRESTIGE_COST = 0,
	
-- Title Claiming Prestige Cost
	BARON_CLAIM_PRESTIGE_COST = 50,
	COUNT_CLAIM_PRESTIGE_COST = 100,
	DUKE_CLAIM_PRESTIGE_COST = 200,
	KING_CLAIM_PRESTIGE_COST = 400, -- Unused, impossible
	EMPEROR_CLAIM_PRESTIGE_COST = 800, -- Unused, impossible
...
-- Title Grant Decadence Reduction (Multiplied with current decadence)
	...
	NORMAL_LAW_CHANGE_COUNCIL_MONTHS = 1,
	NORMAL_LAW_CHANGE_ABSOLUTISM_MONTHS = 1,
	MAX_CROWN_LAW_CHANGES = 1,
	CROWN_LAW_CHANGE_MONTHS = 120,
	...
	MIN_REVOKE_MONTHS_AFTER_GRANT = 1,			-- Months that must pass before you can revoke the title off someone you granted it to
...
NEconomy = {
	...
	LOOT_EVERY_X_DAYS = 1,							-- Loot every this many days
...
NMilitary = {
	...
	DAYS_BETWEEN_COMBAT_EVENTS = 3,				-- Combat events will happen every this many days
	DAYS_BEFORE_FIRST_COMBAT_EVENT = 3,				-- First combat event can't fire before this many days
	...
	MERC_REINFORCE_RATE_WHEN_IDLE = 0.06,			-- The rate at which mercenaries and holy orders reinforce when not hired
	...
	CAPITAL_WARSCORE_MULTIPLIER = 2,				-- Warscore multiplier for capital(this is scaled with SETTLEMENT_WARSCORE_MULTIPLIER)
	...
	CONTROL_SETTLEMENT_SUPPLY_BONUS = 0.5,			-- Supply bonus from occupied settlements
	...
	DAYS_BEFORE_DEFENDER_SALLY = 3,					-- Number of days before defenders sally in a siege where they have superior numbers
	...
	RETINUE_HIRE_COST_MULTIPLIER = 0.0,			-- Retinues are free to hire atm, but they cost a lot to reinforce
	RETINUE_REINFORCE_RATE = 0.05,
	RETINUE_REINFORCE_COST = 1.5,					-- Retinues cost while reinforcing.
	RETINUE_CONSTANT_COST = 0.125, 					-- Retinues cost at all times.
	...
	NOMAD_SUFFER_PAGAN_ATTRITION = 1,						-- Whether pagan nomads suffer attrition in pagan homelands
...
NAI =
{
	...
	CRUSADE_CREATION_MONTH_DELAY = 12,						-- Months from the end of one Crusade before the AI will call a new one
	...
	RAID_MAX_REALM_SIZE = 100000,								-- Realms with more holdings than this will never go on Raids
	RAID_AGGRESSION = 1,									-- General frequency of raids. A LOWER number means more often!
